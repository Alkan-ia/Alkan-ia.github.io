...
import { Target, Users, Lightbulb, Award, Mail, MessageCircle, MapPin } from 'lucide-react';
                        ...
                        <div>
                            <form onSubmit={handleContactSubmit} className="space-y-4">
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    type="submit"
                                    className="w-full px-8 py-4 bg-gradient-to-r from-cyan-500 to-fuchsia-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300"
                                >
